...
from django.contrib.auth import get_user, authenticate, login, logout, BACKEND_SESSION_KEY, load_backend
...
class CustomAuthenticationMiddleware(AuthenticationMiddleware):
    ...
    def process_request(self, request):
        ...
        if backend_str and google_user:
            ...
            if request.user.is_authenticated() and isinstance(backend, AppEngineUserAPI):
